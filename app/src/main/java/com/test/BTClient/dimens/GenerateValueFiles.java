...
public class GenerateValueFiles {
    ...
    private final static String WTemplate = "<dimen name=\"xa{0}\">{1}px</dimen>\n";
    private final static String HTemplate = "<dimen name=\"ya{0}\">{1}px</dimen>\n";
    ...
    private void generateXmlFile(int w, int h) {
        ...
        File layxFile = new File(fileDir.getAbsolutePath(), "lay_xa.xml");
        File layyFile = new File(fileDir.getAbsolutePath(), "lay_ya.xml");
        try {
